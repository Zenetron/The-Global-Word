...
export default function SubmissionForm({ onSubmit, user, onLoginGoogle, onLogout }: SubmissionFormProps) {
  const { t } = useI18n();
      ...
      >
        ...
        {!user ? (
          <div className="flex flex-col items-center py-4 text-center">
            <h2 className="text-xl md:text-2xl font-light text-white mb-6 tracking-wider">
              {t('loginWithGoogle')}
            </h2>
            <button
              type="button"
              onClick={onLoginGoogle}
              className="flex items-center gap-3 px-6 py-3 rounded-full bg-white hover:bg-white/90 text-black border border-white/20 transition-all hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] uppercase tracking-wider text-xs md:text-sm font-bold scale-100 hover:scale-105 active:scale-95 duration-200 cursor-pointer"
            >
