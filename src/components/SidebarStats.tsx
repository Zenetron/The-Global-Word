...
export default function SidebarStats({ globeData, topWords, wordDistributions, countryTrends, onSearchCountry, user, onLoginGoogle, onLogout }: SidebarStatsProps) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Auth : connexion Google ou profil */}
        <div className="mb-5 flex items-center justify-between gap-2">
          {user ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white/70 hover:text-white text-[11px] font-medium transition-all cursor-pointer"
            >
